...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        //тут цикл по чтению ключей, пункт 1
        {
            ...
            {
                if(list.get(i).equals("user")){doWork(new Person.User());}
                if(list.get(i).equals("looser")){doWork(new Person.Looser());}
                if(list.get(i).equals("coder")){doWork(new Person.Coder());}
                if(list.get(i).equals("proger")){doWork(new Person.Proger());}
            }
